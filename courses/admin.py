...
from .models import Topics, Course, CourseDetail, PriceLevel
...
class TopicsAdmin(admin.ModelAdmin):
    ...
    list_display = ("name", "category_type_display", "parent", "total_course", "score", "created_at")
    search_fields = ("name",)
...
class CourseAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ("title", "instructor", "topic", "price", "level", "status", "created_at")
    search_fields = ("title", "instructor__username", "instructor__email", "topic__name")
